...
vec3 rdx_hammon_diffuse(float NdotL, float NdotV, float NdotH, float VdotH, float roughness, vec3 albedo) {
    float facing = 0.5 + 0.5 * VdotH;
    float rough  = facing * (0.9 - 0.4 * facing) * (0.5 / max(NdotH, 0.1) + 1.0);
    float smooth_val = 1.05 * (1.0 - pow(1.0 - NdotL, 5.0)) * (1.0 - pow(1.0 - NdotV, 5.0));
    float single = mix(smooth_val, rough, roughness) * (1.0 / 3.14159265);
    float multi  = 0.1159 * roughness;
    return albedo * (vec3(single) + albedo * multi);
}

// --- RenoDX: EON 2025 Diffuse BRDF (energy-preserving Oren-Nayar + multi-scatter) ---
...
void main()
{
    do
    {
                ...
                if ((_11._m0[_9480]._m6 & (1u << (_617 & 31u))) != 0u)
                {
                    ...
                    if (_9514 < (1.0 / _9518))
                    {
                        ...
                        if (_9533 > 0.0)
                        {
                            ...
                            // --- RenoDX: Diffuse BRDF (Site 1) ---
                            vec3 _rdx_diffuse1;
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse1 = rdx_eon_diffuse(_9533, _9462, 2.0 * _9529 * _9529 - 1.0, _894, _843);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse1 = rdx_hammon_diffuse(_9533, _9462, _9531, _9529, _894, _843);
                            } else {
                                _rdx_diffuse1 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_9703 * pow(spvNMax(abs(1.0 - _9533), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_9703 * pow(spvNMax(abs(1.0 - _9462), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                            }
                            _9756 = fma(_9696, _rdx_diffuse1, _9471);
                        }
                        else
                        {
                            _9755 = _9469;
                ...
                if ((_11._m0[_9778]._m6 & (1u << (_617 & 31u))) != 0u)
                {
                    ...
                    if (_9810 < (1.0 / _9814))
                    {
                        ...
                        if (_9829 > 0.0)
                        {
                            ...
                            // --- RenoDX: Diffuse BRDF (Site 2) ---
                            vec3 _rdx_diffuse2;
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse2 = rdx_eon_diffuse(_9829, _9462, 2.0 * _9825 * _9825 - 1.0, _894, _843);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse2 = rdx_hammon_diffuse(_9829, _9462, _9827, _9825, _894, _843);
                            } else {
                                _rdx_diffuse2 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_9989 * pow(spvNMax(abs(1.0 - _9829), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_9989 * pow(spvNMax(abs(1.0 - _9462), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                            }
                            _10042 = fma(_9982, _rdx_diffuse2, _9769);
                        }
                        else
                        {
                            _10041 = _9767;
                ...
                if (((_13._m0[_10064]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                {
                    ...
                    if (all(lessThan(abs(_10104 - vec3(0.5)), vec3(0.5))))
                    {
                        ...
                        else
                        {
                            _10315 = _10048;
                            _10316 = _10051;
                            _10317 = ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _10209;
                        }
                        vec3 _10358;
                        if (_10093 >= 0)
                        {
                        ...
                        if ((_13._m0[_10064]._m1 & 1u) != 0u)
                        {
                            ...
                            if (_10121 > 0.0)
                            {
                                ...
                                // --- RenoDX: Diffuse BRDF (Site 3) ---
                                vec3 _rdx_diffuse3;
                                if (pc.rendering_diffuse_brdf > 1.5) {
                                    _rdx_diffuse3 = rdx_eon_diffuse(_10121, _9462, 2.0 * _10117 * _10117 - 1.0, _894, _843);
                                } else if (pc.rendering_diffuse_brdf > 0.5) {
                                    _rdx_diffuse3 = rdx_hammon_diffuse(_10121, _9462, _10119, _10117, _894, _843);
                                } else {
                                    _rdx_diffuse3 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_10437 * pow(spvNMax(abs(1.0 - _10121), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_10437 * pow(spvNMax(abs(1.0 - _9462), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                }
                                _10490 = fma(_10430, _rdx_diffuse3, _10055);
                            }
                            else
                            {
                                _10489 = _10053;
                        ...
                        else
                        {
                            ...
                            if (_10121 > 0.0)
                            {
                                ...
                                // --- RenoDX: Diffuse BRDF (Site 4) ---
                                vec3 _rdx_diffuse4;
                                if (pc.rendering_diffuse_brdf > 1.5) {
                                    _rdx_diffuse4 = rdx_eon_diffuse(_10121, _9462, 2.0 * _10117 * _10117 - 1.0, _894, _843);
                                } else if (pc.rendering_diffuse_brdf > 0.5) {
                                    _rdx_diffuse4 = rdx_hammon_diffuse(_10121, _9462, _10119, _10117, _894, _843);
                                } else {
                                    _rdx_diffuse4 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_10372 * pow(spvNMax(abs(1.0 - _10121), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_10372 * pow(spvNMax(abs(1.0 - _9462), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                }
                                _10425 = fma(_10365, _rdx_diffuse4, _10055);
                            }
                            else
                            {
                                _10424 = _10053;
                        ...
                        if (_8216 < (1.0 / _8220))
                        {
                            ...
                            if (_11._m0[_8182]._m3 < 0.0)
                            {
                                ...
                                if (_8235 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Site 5) ---
                                    vec3 _rdx_diffuse5;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        _rdx_diffuse5 = rdx_eon_diffuse(_8235, _8164, 2.0 * _8231 * _8231 - 1.0, _894, _843);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse5 = rdx_hammon_diffuse(_8235, _8164, _8233, _8231, _894, _843);
                                    } else {
                                        _rdx_diffuse5 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_8490 * pow(spvNMax(abs(1.0 - _8235), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_8490 * pow(spvNMax(abs(1.0 - _8164), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                    }
                                    _8560 = fma(_8483, _rdx_diffuse5, _8169);
                                }
                                else
                                {
                                    _8559 = _8166;
                            ...
                            else
                            {
                                ...
                                if (_8235 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Site 6) ---
                                    vec3 _rdx_diffuse6;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        _rdx_diffuse6 = rdx_eon_diffuse(_8235, _8164, 2.0 * _8231 * _8231 - 1.0, _894, _843);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse6 = rdx_hammon_diffuse(_8235, _8164, _8233, _8231, _894, _843);
                                    } else {
                                        _rdx_diffuse6 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_8407 * pow(spvNMax(abs(1.0 - _8235), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_8407 * pow(spvNMax(abs(1.0 - _8164), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                    }
                                    _8477 = fma(_8400, _rdx_diffuse6, _8169);
                                }
                                else
                                {
                                    _8476 = _8166;
                        ...
                        if (_8616 < (1.0 / _8620))
                        {
                            ...
                            if (_11._m0[_8584]._m3 < 0.0)
                            {
                                ...
                                if (_8635 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Site 7) ---
                                    vec3 _rdx_diffuse7;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        _rdx_diffuse7 = rdx_eon_diffuse(_8635, _8164, 2.0 * _8631 * _8631 - 1.0, _894, _843);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse7 = rdx_hammon_diffuse(_8635, _8164, _8633, _8631, _894, _843);
                                    } else {
                                        _rdx_diffuse7 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_8880 * pow(spvNMax(abs(1.0 - _8635), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_8880 * pow(spvNMax(abs(1.0 - _8164), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                    }
                                    _8950 = fma(_8873, _rdx_diffuse7, _8571);
                                }
                                else
                                {
                                    _8949 = _8568;
                            ...
                            else
                            {
                                ...
                                if (_8635 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Site 8) ---
                                    vec3 _rdx_diffuse8;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        _rdx_diffuse8 = rdx_eon_diffuse(_8635, _8164, 2.0 * _8631 * _8631 - 1.0, _894, _843);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse8 = rdx_hammon_diffuse(_8635, _8164, _8633, _8631, _894, _843);
                                    } else {
                                        _rdx_diffuse8 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_8797 * pow(spvNMax(abs(1.0 - _8635), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_8797 * pow(spvNMax(abs(1.0 - _8164), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                    }
                                    _8867 = fma(_8790, _rdx_diffuse8, _8571);
                                }
                                else
                                {
                                    _8866 = _8568;
                    ...
                    if (((_13._m0[_8974]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                    {
                        ...
                        if (all(lessThan(abs(_9014 - vec3(0.5)), vec3(0.5))))
                        {
                            ...
                            else
                            {
                                _9225 = _8963;
                                _9226 = _8965;
                                _9227 = ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _9119;
                            }
                            vec3 _9268;
                            if (_9003 >= 0)
                            {
                            ...
                            if ((_13._m0[_8974]._m1 & 1u) != 0u)
                            {
                                ...
                                if (_9031 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Site 9) ---
                                    vec3 _rdx_diffuse9;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        _rdx_diffuse9 = rdx_eon_diffuse(_9031, _8164, 2.0 * _9027 * _9027 - 1.0, _894, _843);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse9 = rdx_hammon_diffuse(_9031, _8164, _9029, _9027, _894, _843);
                                    } else {
                                        _rdx_diffuse9 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_9366 * pow(spvNMax(abs(1.0 - _9031), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_9366 * pow(spvNMax(abs(1.0 - _8164), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                    }
                                    _9436 = fma(_9359, _rdx_diffuse9, _8961);
                                }
                                else
                                {
                                    _9435 = _8958;
                            ...
                            else
                            {
                                ...
                                if (_9031 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Site 10) ---
                                    vec3 _rdx_diffuse10;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        _rdx_diffuse10 = rdx_eon_diffuse(_9031, _8164, 2.0 * _9027 * _9027 - 1.0, _894, _843);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse10 = rdx_hammon_diffuse(_9031, _8164, _9029, _9027, _894, _843);
                                    } else {
                                        _rdx_diffuse10 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_9283 * pow(spvNMax(abs(1.0 - _9031), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_9283 * pow(spvNMax(abs(1.0 - _8164), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                    }
                                    _9353 = fma(_9276, _rdx_diffuse10, _8961);
                                }
                                else
                                {
                                    _9352 = _8958;
                            ...
                            if (_6597 < (1.0 / _6601))
                            {
                                ...
                                if (_11._m0[_6563]._m3 < 0.0)
                                {
                                    ...
                                    if (_6616 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Site 11) ---
                                        vec3 _rdx_diffuse11;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            _rdx_diffuse11 = rdx_eon_diffuse(_6616, _6545, 2.0 * _6612 * _6612 - 1.0, _894, _843);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse11 = rdx_hammon_diffuse(_6616, _6545, _6614, _6612, _894, _843);
                                        } else {
                                            _rdx_diffuse11 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_6947 * pow(spvNMax(abs(1.0 - _6616), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_6947 * pow(spvNMax(abs(1.0 - _6545), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                        }
                                        _7011 = fma(_6940, _rdx_diffuse11, _6550);
                                    }
                                    else
                                    {
                                        _7010 = _6547;
                                ...
                                else
                                {
                                    ...
                                    if (_6616 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Site 12) ---
                                        vec3 _rdx_diffuse12;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            _rdx_diffuse12 = rdx_eon_diffuse(_6616, _6545, 2.0 * _6612 * _6612 - 1.0, _894, _843);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse12 = rdx_hammon_diffuse(_6616, _6545, _6614, _6612, _894, _843);
                                        } else {
                                            _rdx_diffuse12 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_6863 * pow(spvNMax(abs(1.0 - _6616), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_6863 * pow(spvNMax(abs(1.0 - _6545), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                        }
                                        _6927 = fma(_6856, _rdx_diffuse12, _6550);
                                    }
                                    else
                                    {
                                        _6926 = _6547;
                            ...
                            if (_7076 < (1.0 / _7080))
                            {
                                ...
                                if (_11._m0[_7044]._m3 < 0.0)
                                {
                                    ...
                                    if (_7095 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Site 13) ---
                                        vec3 _rdx_diffuse13;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            _rdx_diffuse13 = rdx_eon_diffuse(_7095, _6545, 2.0 * _7091 * _7091 - 1.0, _894, _843);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse13 = rdx_hammon_diffuse(_7095, _6545, _7093, _7091, _894, _843);
                                        } else {
                                            _rdx_diffuse13 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_7435 * pow(spvNMax(abs(1.0 - _7095), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_7435 * pow(spvNMax(abs(1.0 - _6545), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                        }
                                        _7499 = fma(_7428, _rdx_diffuse13, _7031);
                                    }
                                    else
                                    {
                                        _7498 = _7028;
                                ...
                                else
                                {
                                    ...
                                    if (_7095 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Site 14) ---
                                        vec3 _rdx_diffuse14;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            _rdx_diffuse14 = rdx_eon_diffuse(_7095, _6545, 2.0 * _7091 * _7091 - 1.0, _894, _843);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse14 = rdx_hammon_diffuse(_7095, _6545, _7093, _7091, _894, _843);
                                        } else {
                                            _rdx_diffuse14 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_7351 * pow(spvNMax(abs(1.0 - _7095), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_7351 * pow(spvNMax(abs(1.0 - _6545), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                        }
                                        _7415 = fma(_7344, _rdx_diffuse14, _7031);
                                    }
                                    else
                                    {
                                        _7414 = _7028;
                        ...
                        if (((_13._m0[_7532]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                        {
                            ...
                            if (all(lessThan(abs(_7572 - vec3(0.5)), vec3(0.5))))
                            {
                                ...
                                else
                                {
                                    _7814 = _7521;
                                    _7815 = _7523;
                                    _7816 = ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _7677;
                                    _7817 = 0.0;
                                    _7818 = 1.0;
                                }
                                float _7924;
                                ...
                                if ((_13._m0[_7532]._m1 & 1u) != 0u)
                                {
                                    ...
                                    if (_7589 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Site 15) ---
                                        vec3 _rdx_diffuse15;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            _rdx_diffuse15 = rdx_eon_diffuse(_7589, _6545, 2.0 * _7585 * _7585 - 1.0, _894, _843);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse15 = rdx_hammon_diffuse(_7589, _6545, _7587, _7585, _894, _843);
                                        } else {
                                            _rdx_diffuse15 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_8065 * pow(spvNMax(abs(1.0 - _7589), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_8065 * pow(spvNMax(abs(1.0 - _6545), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                        }
                                        _8129 = fma(_8058, _rdx_diffuse15, _7519);
                                    }
                                    else
                                    {
                                        _8128 = _7516;
                                ...
                                else
                                {
                                    ...
                                    if (_7589 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Site 16) ---
                                        vec3 _rdx_diffuse16;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            _rdx_diffuse16 = rdx_eon_diffuse(_7589, _6545, 2.0 * _7585 * _7585 - 1.0, _894, _843);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse16 = rdx_hammon_diffuse(_7589, _6545, _7587, _7585, _894, _843);
                                        } else {
                                            _rdx_diffuse16 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_7981 * pow(spvNMax(abs(1.0 - _7589), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_7981 * pow(spvNMax(abs(1.0 - _6545), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                        }
                                        _8045 = fma(_7974, _rdx_diffuse16, _7519);
                                    }
                                    else
                                    {
                                        _8044 = _7516;
                                ...
                                if (_5090 < (1.0 / _5094))
                                {
                                    ...
                                    if (_11._m0[_5056]._m3 < 0.0)
                                    {
                                        ...
                                        if (_5109 > 0.0)
                                        {
                                            ...
                                            // --- RenoDX: Diffuse BRDF (Site 17) ---
                                            vec3 _rdx_diffuse17;
                                            if (pc.rendering_diffuse_brdf > 1.5) {
                                                _rdx_diffuse17 = rdx_eon_diffuse(_5109, _5038, 2.0 * _5105 * _5105 - 1.0, _894, _843);
                                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                _rdx_diffuse17 = rdx_hammon_diffuse(_5109, _5038, _5107, _5105, _894, _843);
                                            } else {
                                                _rdx_diffuse17 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_5420 * pow(spvNMax(abs(1.0 - _5109), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_5420 * pow(spvNMax(abs(1.0 - _5038), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                            }
                                            _5473 = fma(_5413, _rdx_diffuse17, _5043);
                                        }
                                        else
                                        {
                                            _5472 = _5040;
                                    ...
                                    else
                                    {
                                        ...
                                        if (_5109 > 0.0)
                                        {
                                            ...
                                            // --- RenoDX: Diffuse BRDF (Site 18) ---
                                            vec3 _rdx_diffuse18;
                                            if (pc.rendering_diffuse_brdf > 1.5) {
                                                _rdx_diffuse18 = rdx_eon_diffuse(_5109, _5038, 2.0 * _5105 * _5105 - 1.0, _894, _843);
                                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                _rdx_diffuse18 = rdx_hammon_diffuse(_5109, _5038, _5107, _5105, _894, _843);
                                            } else {
                                                _rdx_diffuse18 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_5350 * pow(spvNMax(abs(1.0 - _5109), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_5350 * pow(spvNMax(abs(1.0 - _5038), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                            }
                                            _5403 = fma(_5343, _rdx_diffuse18, _5043);
                                        }
                                        else
                                        {
                                            _5402 = _5040;
                                ...
                                if (_5535 < (1.0 / _5539))
                                {
                                    ...
                                    if (_11._m0[_5503]._m3 < 0.0)
                                    {
                                        ...
                                        if (_5554 > 0.0)
                                        {
                                            ...
                                            // --- RenoDX: Diffuse BRDF (Site 19) ---
                                            vec3 _rdx_diffuse19;
                                            if (pc.rendering_diffuse_brdf > 1.5) {
                                                _rdx_diffuse19 = rdx_eon_diffuse(_5554, _5038, 2.0 * _5550 * _5550 - 1.0, _894, _843);
                                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                _rdx_diffuse19 = rdx_hammon_diffuse(_5554, _5038, _5552, _5550, _894, _843);
                                            } else {
                                                _rdx_diffuse19 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_5874 * pow(spvNMax(abs(1.0 - _5554), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_5874 * pow(spvNMax(abs(1.0 - _5038), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                            }
                                            _5927 = fma(_5867, _rdx_diffuse19, _5490);
                                        }
                                        else
                                        {
                                            _5926 = _5487;
                                    ...
                                    else
                                    {
                                        ...
                                        if (_5554 > 0.0)
                                        {
                                            ...
                                            // --- RenoDX: Diffuse BRDF (Site 20) ---
                                            vec3 _rdx_diffuse20;
                                            if (pc.rendering_diffuse_brdf > 1.5) {
                                                _rdx_diffuse20 = rdx_eon_diffuse(_5554, _5038, 2.0 * _5550 * _5550 - 1.0, _894, _843);
                                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                _rdx_diffuse20 = rdx_hammon_diffuse(_5554, _5038, _5552, _5550, _894, _843);
                                            } else {
                                                _rdx_diffuse20 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_5804 * pow(spvNMax(abs(1.0 - _5554), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_5804 * pow(spvNMax(abs(1.0 - _5038), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                            }
                                            _5857 = fma(_5797, _rdx_diffuse20, _5490);
                                        }
                                        else
                                        {
                                            _5856 = _5487;
                            ...
                            if (((_13._m0[_5957]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                            {
                                ...
                                if (all(lessThan(abs(_5997 - vec3(0.5)), vec3(0.5))))
                                {
                                    ...
                                    else
                                    {
                                        _6238 = _5946;
                                        _6239 = _5948;
                                        _6240 = ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _6102;
                                        _6241 = 0.0;
                                        _6242 = 1.0;
                                    }
                                    ...
                                    if ((_13._m0[_5957]._m1 & 1u) != 0u)
                                    {
                                        ...
                                        if (_6014 > 0.0)
                                        {
                                            ...
                                            // --- RenoDX: Diffuse BRDF (Site 21) ---
                                            vec3 _rdx_diffuse21;
                                            if (pc.rendering_diffuse_brdf > 1.5) {
                                                _rdx_diffuse21 = rdx_eon_diffuse(_6014, _5038, 2.0 * _6010 * _6010 - 1.0, _894, _843);
                                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                _rdx_diffuse21 = rdx_hammon_diffuse(_6014, _5038, _6012, _6010, _894, _843);
                                            } else {
                                                _rdx_diffuse21 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_6460 * pow(spvNMax(abs(1.0 - _6014), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_6460 * pow(spvNMax(abs(1.0 - _5038), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                            }
                                            _6513 = fma(_6453, _rdx_diffuse21, _5944);
                                        }
                                        else
                                        {
                                            _6512 = _5941;
                                    ...
                                    else
                                    {
                                        ...
                                        if (_6014 > 0.0)
                                        {
                                            ...
                                            // --- RenoDX: Diffuse BRDF (Site 22) ---
                                            vec3 _rdx_diffuse22;
                                            if (pc.rendering_diffuse_brdf > 1.5) {
                                                _rdx_diffuse22 = rdx_eon_diffuse(_6014, _5038, 2.0 * _6010 * _6010 - 1.0, _894, _843);
                                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                _rdx_diffuse22 = rdx_hammon_diffuse(_6014, _5038, _6012, _6010, _894, _843);
                                            } else {
                                                _rdx_diffuse22 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_6390 * pow(spvNMax(abs(1.0 - _6014), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_6390 * pow(spvNMax(abs(1.0 - _5038), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                            }
                                            _6443 = fma(_6383, _rdx_diffuse22, _5944);
                                        }
                                        else
                                        {
                                            _6442 = _5941;
                                ...
                                if (((_13._m0[_4440]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                                {
                                    ...
                                    if (all(lessThan(abs(_4480 - vec3(0.5)), vec3(0.5))))
                                    {
                                        ...
                                        else
                                        {
                                            _4666 = _4429;
                                            _4667 = _4431;
                                            _4668 = ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : clamp(fma(2.0, _4574, 0.5), 0.0, 1.0);
                                        }
                                        ...
                                        if (_2352 < (1.0 / _2356))
                                        {
                                            ...
                                            if (_11._m0[_2318]._m3 < 0.0)
                                            {
                                                ...
                                                if (_2371 > 0.0)
                                                {
                                                    ...
                                                    // --- RenoDX: Diffuse BRDF (Site 23) ---
                                                    vec3 _rdx_diffuse23;
                                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                                        _rdx_diffuse23 = rdx_eon_diffuse(_2371, _2300, 2.0 * _2367 * _2367 - 1.0, _894, _843);
                                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                        _rdx_diffuse23 = rdx_hammon_diffuse(_2371, _2300, _2369, _2367, _894, _843);
                                                    } else {
                                                        _rdx_diffuse23 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2594 * pow(spvNMax(abs(1.0 - _2371), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2594 * pow(spvNMax(abs(1.0 - _2300), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                    }
                                                    _2634 = fma(_2587, _rdx_diffuse23, _2305);
                                                }
                                                else
                                                {
                                                    _2633 = _2302;
                                            ...
                                            else
                                            {
                                                ...
                                                if (_2371 > 0.0)
                                                {
                                                    ...
                                                    // --- RenoDX: Diffuse BRDF (Site 24) ---
                                                    vec3 _rdx_diffuse24;
                                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                                        _rdx_diffuse24 = rdx_eon_diffuse(_2371, _2300, 2.0 * _2367 * _2367 - 1.0, _894, _843);
                                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                        _rdx_diffuse24 = rdx_hammon_diffuse(_2371, _2300, _2369, _2367, _894, _843);
                                                    } else {
                                                        _rdx_diffuse24 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2542 * pow(spvNMax(abs(1.0 - _2371), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2542 * pow(spvNMax(abs(1.0 - _2300), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                    }
                                                    _2582 = fma(_2535, _rdx_diffuse24, _2305);
                                                }
                                                else
                                                {
                                                    _2581 = _2302;
                                        ...
                                        if (_2690 < (1.0 / _2694))
                                        {
                                            ...
                                            if (_11._m0[_2658]._m3 < 0.0)
                                            {
                                                ...
                                                if (_2709 > 0.0)
                                                {
                                                    ...
                                                    // --- RenoDX: Diffuse BRDF (Site 25) ---
                                                    vec3 _rdx_diffuse25;
                                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                                        _rdx_diffuse25 = rdx_eon_diffuse(_2709, _2300, 2.0 * _2705 * _2705 - 1.0, _894, _843);
                                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                        _rdx_diffuse25 = rdx_hammon_diffuse(_2709, _2300, _2707, _2705, _894, _843);
                                                    } else {
                                                        _rdx_diffuse25 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2922 * pow(spvNMax(abs(1.0 - _2709), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2922 * pow(spvNMax(abs(1.0 - _2300), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                    }
                                                    _2962 = fma(_2915, _rdx_diffuse25, _2645);
                                                }
                                                else
                                                {
                                                    _2961 = _2642;
                                            ...
                                            else
                                            {
                                                ...
                                                if (_2709 > 0.0)
                                                {
                                                    ...
                                                    // --- RenoDX: Diffuse BRDF (Site 26) ---
                                                    vec3 _rdx_diffuse26;
                                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                                        _rdx_diffuse26 = rdx_eon_diffuse(_2709, _2300, 2.0 * _2705 * _2705 - 1.0, _894, _843);
                                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                        _rdx_diffuse26 = rdx_hammon_diffuse(_2709, _2300, _2707, _2705, _894, _843);
                                                    } else {
                                                        _rdx_diffuse26 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2870 * pow(spvNMax(abs(1.0 - _2709), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2870 * pow(spvNMax(abs(1.0 - _2300), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                    }
                                                    _2910 = fma(_2863, _rdx_diffuse26, _2645);
                                                }
                                                else
                                                {
                                                    _2909 = _2642;
                                    ...
                                    if (((_13._m0[_2986]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                                    {
                                        ...
                                        if (all(lessThan(abs(_3026 - vec3(0.5)), vec3(0.5))))
                                        {
                                            ...
                                            else
                                            {
                                                _3237 = _2975;
                                                _3238 = _2977;
                                                _3239 = ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _3131;
                                            }
                                            vec3 _3280;
                                            if (_3015 >= 0)
                                            {
                                            ...
                                            if ((_13._m0[_2986]._m1 & 1u) != 0u)
                                            {
                                                ...
                                                if (_3043 > 0.0)
                                                {
                                                    ...
                                                    // --- RenoDX: Diffuse BRDF (Site 27) ---
                                                    vec3 _rdx_diffuse27;
                                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                                        _rdx_diffuse27 = rdx_eon_diffuse(_3043, _2300, 2.0 * _3039 * _3039 - 1.0, _894, _843);
                                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                        _rdx_diffuse27 = rdx_hammon_diffuse(_3043, _2300, _3041, _3039, _894, _843);
                                                    } else {
                                                        _rdx_diffuse27 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_3346 * pow(spvNMax(abs(1.0 - _3043), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_3346 * pow(spvNMax(abs(1.0 - _2300), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                    }
                                                    _3386 = fma(_3339, _rdx_diffuse27, _2973);
                                                }
                                                else
                                                {
                                                    _3385 = _2970;
                                            ...
                                            else
                                            {
                                                ...
                                                if (_3043 > 0.0)
                                                {
                                                    ...
                                                    // --- RenoDX: Diffuse BRDF (Site 28) ---
                                                    vec3 _rdx_diffuse28;
                                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                                        _rdx_diffuse28 = rdx_eon_diffuse(_3043, _2300, 2.0 * _3039 * _3039 - 1.0, _894, _843);
                                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                        _rdx_diffuse28 = rdx_hammon_diffuse(_3043, _2300, _3041, _3039, _894, _843);
                                                    } else {
                                                        _rdx_diffuse28 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_3294 * pow(spvNMax(abs(1.0 - _3043), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_3294 * pow(spvNMax(abs(1.0 - _2300), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                    }
                                                    _3334 = fma(_3287, _rdx_diffuse28, _2973);
                                                }
                                                else
                                                {
                                                    _3333 = _2970;
                                            ...
                                            if (_1036 < (1.0 / _1040))
                                            {
                                                ...
                                                if (_11._m0[_1002]._m3 < 0.0)
                                                {
                                                    ...
                                                    if (_1055 > 0.0)
                                                    {
                                                        ...
                                                        // --- RenoDX: Diffuse BRDF (Site 29) ---
                                                        vec3 _rdx_diffuse29;
                                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                                            _rdx_diffuse29 = rdx_eon_diffuse(_1055, _984, 2.0 * _1051 * _1051 - 1.0, _894, _843);
                                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                            _rdx_diffuse29 = rdx_hammon_diffuse(_1055, _984, _1053, _1051, _894, _843);
                                                        } else {
                                                            _rdx_diffuse29 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1312 * pow(spvNMax(abs(1.0 - _1055), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1312 * pow(spvNMax(abs(1.0 - _984), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                        }
                                                        _1386 = fma(_1305, _rdx_diffuse29, _989);
                                                    }
                                                    else
                                                    {
                                                        _1385 = _986;
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (_1055 > 0.0)
                                                    {
                                                        ...
                                                        // --- RenoDX: Diffuse BRDF (Site 30) ---
                                                        vec3 _rdx_diffuse30;
                                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                                            _rdx_diffuse30 = rdx_eon_diffuse(_1055, _984, 2.0 * _1051 * _1051 - 1.0, _894, _843);
                                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                            _rdx_diffuse30 = rdx_hammon_diffuse(_1055, _984, _1053, _1051, _894, _843);
                                                        } else {
                                                            _rdx_diffuse30 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1226 * pow(spvNMax(abs(1.0 - _1055), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1226 * pow(spvNMax(abs(1.0 - _984), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                        }
                                                        _1300 = fma(_1219, _rdx_diffuse30, _989);
                                                    }
                                                    else
                                                    {
                                                        _1299 = _986;
                                            ...
                                            if (_1442 < (1.0 / _1446))
                                            {
                                                ...
                                                if (_11._m0[_1410]._m3 < 0.0)
                                                {
                                                    ...
                                                    if (_1461 > 0.0)
                                                    {
                                                        ...
                                                        // --- RenoDX: Diffuse BRDF (Site 31) ---
                                                        vec3 _rdx_diffuse31;
                                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                                            _rdx_diffuse31 = rdx_eon_diffuse(_1461, _984, 2.0 * _1457 * _1457 - 1.0, _894, _843);
                                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                            _rdx_diffuse31 = rdx_hammon_diffuse(_1461, _984, _1459, _1457, _894, _843);
                                                        } else {
                                                            _rdx_diffuse31 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1708 * pow(spvNMax(abs(1.0 - _1461), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1708 * pow(spvNMax(abs(1.0 - _984), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                        }
                                                        _1782 = fma(_1701, _rdx_diffuse31, _1397);
                                                    }
                                                    else
                                                    {
                                                        _1781 = _1394;
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (_1461 > 0.0)
                                                    {
                                                        ...
                                                        // --- RenoDX: Diffuse BRDF (Site 32) ---
                                                        vec3 _rdx_diffuse32;
                                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                                            _rdx_diffuse32 = rdx_eon_diffuse(_1461, _984, 2.0 * _1457 * _1457 - 1.0, _894, _843);
                                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                            _rdx_diffuse32 = rdx_hammon_diffuse(_1461, _984, _1459, _1457, _894, _843);
                                                        } else {
                                                            _rdx_diffuse32 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1622 * pow(spvNMax(abs(1.0 - _1461), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1622 * pow(spvNMax(abs(1.0 - _984), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                        }
                                                        _1696 = fma(_1615, _rdx_diffuse32, _1397);
                                                    }
                                                    else
                                                    {
                                                        _1695 = _1394;
                                        ...
                                        if (((_13._m0[_1806]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                                        {
                                            ...
                                            if (all(lessThan(abs(_1846 - vec3(0.5)), vec3(0.5))))
                                            {
                                                ...
                                                else
                                                {
                                                    _2057 = _1795;
                                                    _2058 = _1797;
                                                    _2059 = ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _1951;
                                                }
                                                vec3 _2100;
                                                if (_1835 >= 0)
                                                {
                                                ...
                                                if ((_13._m0[_1806]._m1 & 1u) != 0u)
                                                {
                                                    ...
                                                    if (_1863 > 0.0)
                                                    {
                                                        ...
                                                        // --- RenoDX: Diffuse BRDF (Site 33) ---
                                                        vec3 _rdx_diffuse33;
                                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                                            _rdx_diffuse33 = rdx_eon_diffuse(_1863, _984, 2.0 * _1859 * _1859 - 1.0, _894, _843);
                                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                            _rdx_diffuse33 = rdx_hammon_diffuse(_1863, _984, _1861, _1859, _894, _843);
                                                        } else {
                                                            _rdx_diffuse33 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2200 * pow(spvNMax(abs(1.0 - _1863), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2200 * pow(spvNMax(abs(1.0 - _984), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                        }
                                                        _2274 = fma(_2193, _rdx_diffuse33, _1793);
                                                    }
                                                    else
                                                    {
                                                        _2273 = _1790;
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (_1863 > 0.0)
                                                    {
                                                        ...
                                                        // --- RenoDX: Diffuse BRDF (Site 34) ---
                                                        vec3 _rdx_diffuse34;
                                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                                            _rdx_diffuse34 = rdx_eon_diffuse(_1863, _984, 2.0 * _1859 * _1859 - 1.0, _894, _843);
                                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                                            _rdx_diffuse34 = rdx_hammon_diffuse(_1863, _984, _1861, _1859, _894, _843);
                                                        } else {
                                                            _rdx_diffuse34 = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2114 * pow(spvNMax(abs(1.0 - _1863), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2114 * pow(spvNMax(abs(1.0 - _984), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                                        }
                                                        _2188 = fma(_2107, _rdx_diffuse34, _1793);
                                                    }
                                                    else
                                                    {
                                                        _2187 = _1790;
        ...
        if (_37._m0.x > 0.0) {
            _rdx_early_ao = textureLod(sampler2D(_43, _14), _546, 0.0).x;
        }
        // --- RenoDX: IBL Modulation ---
        if (pc.rendering_cubemap_mod > 0.5) {
            float rdx_mod = rdx_cubemap_modulation(_10555, _894, _rdx_early_ao);
            _10628 *= rdx_mod;
            _10629 *= rdx_mod;
        }
        ...
        for (uint _10654 = _10645; _10654 < _10647; _10649 = _10650, _10652 = _10653, _10654++)
        {
            ...
            if ((_10680 & 1) != 0)
            {
                ...
                if (_633)
                {
                    ...
                    if (pc.rendering_cubemap_mod > 0.5) {
                        _11048.xyz *= mix(0.4, 1.0, _rdx_early_ao);
                    }
                ...
                float _rdx_probeBlendD = _11052.w;
                if ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) {
                    _rdx_probeBlendD *= 0.3;
                }
                _11057 = mix(_10652, _11052.xyz, vec3(_rdx_probeBlendD));
            }
            else
            {
                _11057 = _10652;
            ...
            if ((_10680 & 2) != 0)
            {
                ...
                if (_633)
                {
                    ...
                    if (pc.rendering_cubemap_mod > 0.5) {
                        _11405.xyz *= mix(0.4, 1.0, _rdx_early_ao);
                    }
                ...
                float _rdx_probeBlendS = _11409.w;
                if ((_617 == 5u || _617 == 7u) && pc.hero_lighting > 0.5) {
                    _rdx_probeBlendS *= 0.3;
                }
                _11414 = mix(_10649, _11409.xyz, vec3(_rdx_probeBlendS));
            }
            else
            {
                _11414 = _10649;
        ...
        if (_943)
        {
            ...
            float _rdx_sun_NdotH = clamp(dot(_673, normalize(_861 + _29._m0)), 0.0, 1.0);
            vec3 _rdx_sun_diffuse;
            if (pc.rendering_diffuse_brdf > 1.5) {
                _rdx_sun_diffuse = rdx_eon_diffuse(_12432, _12426, 2.0 * _12430 * _12430 - 1.0, _894, _843);
            } else if (pc.rendering_diffuse_brdf > 0.5) {
                _rdx_sun_diffuse = rdx_hammon_diffuse(_12432, _12426, _rdx_sun_NdotH, _12430, _894, _843);
            } else {
                _rdx_sun_diffuse = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_12439 * pow(spvNMax(abs(1.0 - _12432), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_12439 * pow(spvNMax(abs(1.0 - _12426), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
            }
            _12515 = _10498 + ((_11743 * _rdx_sun_diffuse) * _12432);
        }
        else
        {
            vec3 _12420;
            ...
            if (_686)
            {
                ...
                vec3 _rdx_sun_diffuse;
                if (pc.rendering_diffuse_brdf > 1.5) {
                    _rdx_sun_diffuse = rdx_eon_diffuse(_12320, _12314, 2.0 * _12318 * _12318 - 1.0, _894, _843);
                } else if (pc.rendering_diffuse_brdf > 0.5) {
                    _rdx_sun_diffuse = rdx_hammon_diffuse(_12320, _12314, _rdx_sun_NdotH, _12318, _894, _843);
                } else {
                    _rdx_sun_diffuse = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_12327 * pow(spvNMax(abs(1.0 - _12320), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_12327 * pow(spvNMax(abs(1.0 - _12314), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                }
                _12421 = _10498 + ((_11743 * _rdx_sun_diffuse) * _12320);
            }
            else
            {
                vec3 _12308;
                ...
                if (_674)
                {
                    ...
                    vec3 _rdx_sun_diffuse;
                    if (pc.rendering_diffuse_brdf > 1.5) {
                        _rdx_sun_diffuse = rdx_eon_diffuse(_12215, _12209, 2.0 * _12213 * _12213 - 1.0, _894, _843);
                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                        _rdx_sun_diffuse = rdx_hammon_diffuse(_12215, _12209, _rdx_sun_NdotH, _12213, _894, _843);
                    } else {
                        _rdx_sun_diffuse = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_12222 * pow(spvNMax(abs(1.0 - _12215), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_12222 * pow(spvNMax(abs(1.0 - _12209), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                    }
                    _12309 = _10498 + ((_11743 * _rdx_sun_diffuse) * _12215);
                }
                else
                {
                    vec3 _12203;
                    ...
                    if (_615 == 4u)
                    {
                        ...
                        vec3 _rdx_sun_diffuse;
                        if (pc.rendering_diffuse_brdf > 1.5) {
                            _rdx_sun_diffuse = rdx_eon_diffuse(_12121, _12115, 2.0 * _12119 * _12119 - 1.0, _894, _843);
                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                            _rdx_sun_diffuse = rdx_hammon_diffuse(_12121, _12115, _rdx_sun_NdotH, _12119, _894, _843);
                        } else {
                            _rdx_sun_diffuse = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_12128 * pow(spvNMax(abs(1.0 - _12121), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_12128 * pow(spvNMax(abs(1.0 - _12115), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                        }
                        _12204 = _10498 + ((_11743 * _rdx_sun_diffuse) * _12121);
                    }
                    else
                    {
                        vec3 _12109;
                        ...
                        else
                        {
                            ...
                            if (_615 == 6u)
                            {
                                ...
                                vec3 _rdx_sun_diffuse;
                                if (pc.rendering_diffuse_brdf > 1.5) {
                                    _rdx_sun_diffuse = rdx_eon_diffuse(_11889, _11883, 2.0 * _11887 * _11887 - 1.0, _894, _843);
                                } else if (pc.rendering_diffuse_brdf > 0.5) {
                                    _rdx_sun_diffuse = rdx_hammon_diffuse(_11889, _11883, _rdx_sun_NdotH, _11887, _894, _843);
                                } else {
                                    _rdx_sun_diffuse = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_11896 * pow(spvNMax(abs(1.0 - _11889), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_11896 * pow(spvNMax(abs(1.0 - _11883), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                }
                                _11956 = _10498 + ((_11743 * _rdx_sun_diffuse) * _11889);
                            }
                            else
                            {
                                vec3 _11877;
                                ...
                                if (_10506)
                                {
                                    ...
                                    vec3 _rdx_sun_diffuse;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        _rdx_sun_diffuse = rdx_eon_diffuse(_11776, _11770, 2.0 * _11774 * _11774 - 1.0, _894, _843);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_sun_diffuse = rdx_hammon_diffuse(_11776, _11770, _rdx_sun_NdotH, _11774, _894, _843);
                                    } else {
                                        _rdx_sun_diffuse = _843 * (0.3183098733425140380859375 * (((vec3(1.0) + (_11783 * pow(spvNMax(abs(1.0 - _11776), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_11783 * pow(spvNMax(abs(1.0 - _11770), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _894)));
                                    }
                                    _11878 = _10498 + ((_11743 * _rdx_sun_diffuse) * _11776);
                                }
                                else
                                {
                                    _11877 = _10497;
        ...
        if (pc.rendering_specular_occlusion > 0.5) {
            float _rdx_specOcc = clamp(
                pow(spvNMax(abs(_10505 + _12574), 1e-7),
                    exp2(-16.0 * _894 - 1.0)) - 1.0 + _12574,
                0.0, 1.0);
            float _rdx_specOccBlend = mix(_rdx_specOcc, 1.0, (1.0 - _894) * 0.5);
            _10649 *= _rdx_specOccBlend;
        }
        // --- RenoDX: AO-Weighted Probe Light Leak Fix ---
        if (pc.rendering_probe_ao > 0.5) {
            float _rdx_probe_weight = mix(1.0, _12574, 0.6);
            _10649 *= _rdx_probe_weight;
            _10652 *= _rdx_probe_weight;
        }
        // --- RenoDX: Horizon Occlusion on Indirect Light ---
        if (pc.rendering_horizon_occlusion > 0.5) {
            float _rdx_NdotR = dot(_673, _10500);
