...
void main()
{
    do
    {
                ...
                if (_677 < (1.0 / _681))
                {
                    ...
                    if (_10._m0[_643]._m3 < 0.0)
                    {
                        ...
                        if (_696 > 0.0)
                        {
                            ...
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse_p1 = rdx_eon_diffuse(_696, _625, 2.0 * _692 * _692 - 1.0, _559, _487);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse_p1 = rdx_hammon_diffuse(_696, _625, _694, _692, _559, _487);
                            } else {
                                _rdx_diffuse_p1 = _487 * (0.3183098733425140380859375 * (((vec3(1.0) + (_950 * pow(spvNMax(abs(1.0 - _696), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_950 * pow(spvNMax(abs(1.0 - _625), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _559)));
                            }
                            _1020 = fma(_943, _rdx_diffuse_p1, _634);
                        }
                        else
                        {
                            _1019 = _632;
                    ...
                    else
                    {
                        ...
                        if (_696 > 0.0)
                        {
                            ...
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse_p2 = rdx_eon_diffuse(_696, _625, 2.0 * _692 * _692 - 1.0, _559, _487);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse_p2 = rdx_hammon_diffuse(_696, _625, _694, _692, _559, _487);
                            } else {
                                _rdx_diffuse_p2 = _487 * (0.3183098733425140380859375 * (((vec3(1.0) + (_867 * pow(spvNMax(abs(1.0 - _696), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_867 * pow(spvNMax(abs(1.0 - _625), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _559)));
                            }
                            _937 = fma(_860, _rdx_diffuse_p2, _634);
                        }
                        else
                        {
                            _936 = _632;
                ...
                if (_1076 < (1.0 / _1080))
                {
                    ...
                    if (_10._m0[_1044]._m3 < 0.0)
                    {
                        ...
                        if (_1095 > 0.0)
                        {
                            ...
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse_s1 = rdx_eon_diffuse(_1095, _625, 2.0 * _1091 * _1091 - 1.0, _559, _487);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse_s1 = rdx_hammon_diffuse(_1095, _625, _1093, _1091, _559, _487);
                            } else {
                                _rdx_diffuse_s1 = _487 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1339 * pow(spvNMax(abs(1.0 - _1095), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1339 * pow(spvNMax(abs(1.0 - _625), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _559)));
                            }
                            _1409 = fma(_1332, _rdx_diffuse_s1, _1035);
                        }
                        else
                        {
                            _1408 = _1033;
                    ...
                    else
                    {
                        ...
                        if (_1095 > 0.0)
                        {
                            ...
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse_s2 = rdx_eon_diffuse(_1095, _625, 2.0 * _1091 * _1091 - 1.0, _559, _487);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse_s2 = rdx_hammon_diffuse(_1095, _625, _1093, _1091, _559, _487);
                            } else {
                                _rdx_diffuse_s2 = _487 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1256 * pow(spvNMax(abs(1.0 - _1095), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1256 * pow(spvNMax(abs(1.0 - _625), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _559)));
                            }
                            _1326 = fma(_1249, _rdx_diffuse_s2, _1035);
                        }
                        else
                        {
                            _1325 = _1033;
            ...
            if (((_11._m0[_1433]._m4 & 16777215u) & (1u << (_474 & 31u))) != 0u)
            {
                ...
                if (all(lessThan(abs(_1473 - vec3(0.5)), vec3(0.5))))
                {
                    ...
                    else
                    {
                        _1683 = _1417;
                        _1684 = _1420;
                        _1685 = ((_474 == 5u || _474 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _1578;
                    }
                    vec3 _1718;
                    if (_1462 >= 0)
                    {
                    ...
                    if ((_11._m0[_1433]._m1 & 1u) != 0u)
                    {
                        ...
                        if (_1490 > 0.0)
                        {
                            ...
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse_a1 = rdx_eon_diffuse(_1490, _625, 2.0 * _1486 * _1486 - 1.0, _559, _487);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse_a1 = rdx_hammon_diffuse(_1490, _625, _1488, _1486, _559, _487);
                            } else {
                                _rdx_diffuse_a1 = _487 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1816 * pow(spvNMax(abs(1.0 - _1490), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1816 * pow(spvNMax(abs(1.0 - _625), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _559)));
                            }
                            _1886 = fma(_1809, _rdx_diffuse_a1, _1424);
                        }
                        else
                        {
                            _1885 = _1422;
                    ...
                    else
                    {
                        ...
                        if (_1490 > 0.0)
                        {
                            ...
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                _rdx_diffuse_a2 = rdx_eon_diffuse(_1490, _625, 2.0 * _1486 * _1486 - 1.0, _559, _487);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse_a2 = rdx_hammon_diffuse(_1490, _625, _1488, _1486, _559, _487);
                            } else {
                                _rdx_diffuse_a2 = _487 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1733 * pow(spvNMax(abs(1.0 - _1490), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1733 * pow(spvNMax(abs(1.0 - _625), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _559)));
                            }
                            _1803 = fma(_1726, _rdx_diffuse_a2, _1424);
                        }
                        else
                        {
                            _1802 = _1422;
        ...
        if (_34._m0.x > 0.0) {
            _rdx_early_ao = textureLod(sampler2D(_40, _12), _404, 0.0).x;
        }
        // --- RenoDX: IBL Modulation ---
        if (pc.rendering_cubemap_mod > 0.5) {
            float rdx_mod = rdx_cubemap_modulation(_1939, _559, _rdx_early_ao);
            _1938 *= rdx_mod;
            _1939 *= rdx_mod;
        }
        ...
        for (uint _1977 = _1968; _1977 < _1970; _1972 = _1973, _1975 = _1976, _1977++)
        {
            ...
            if ((_2003 & 1) != 0)
            {
                ...
                if (pc.rendering_cubemap_mod > 0.5) {
                    _2207.xyz *= mix(0.4, 1.0, _rdx_early_ao);
                }
                float _rdx_probeBlendD = _2207.w;
                if ((_474 == 5u || _474 == 7u) && pc.hero_lighting > 0.5) {
                    _rdx_probeBlendD *= 0.3;
                }
                _2212 = mix(_1975, _2207.xyz, vec3(_rdx_probeBlendD));
            }
            else
            {
                _2212 = _1975;
            ...
            if ((_2003 & 2) != 0)
            {
                ...
                if (pc.rendering_cubemap_mod > 0.5) {
                    _2386.xyz *= mix(0.4, 1.0, _rdx_early_ao);
                }
                float _rdx_probeBlendS = _2386.w;
                if ((_474 == 5u || _474 == 7u) && pc.hero_lighting > 0.5) {
                    _rdx_probeBlendS *= 0.3;
                }
                _2391 = mix(_1972, _2386.xyz, vec3(_rdx_probeBlendS));
            }
            else
            {
                _2391 = _1972;
        ...
        if (pc.rendering_specular_occlusion > 0.5) {
            float _rdx_specOcc = clamp(
                pow(spvNMax(abs(_625 + _2776), 1e-7),
                    exp2(-16.0 * _559 - 1.0)) - 1.0 + _2776,
                0.0, 1.0);
            float _rdx_specOccBlend = mix(_rdx_specOcc, 1.0, (1.0 - _559) * 0.5);
            _1972 *= _rdx_specOccBlend;
        }
        // --- RenoDX: AO-Weighted Probe Light Leak Fix ---
        if (pc.rendering_probe_ao > 0.5) {
            float _rdx_probe_weight = mix(1.0, _2776, 0.6);
            _1972 *= _rdx_probe_weight;
            _1975 *= _rdx_probe_weight;
        }
        // --- RenoDX: Horizon Occlusion on Indirect Light ---
        if (pc.rendering_horizon_occlusion > 0.5) {
            float _rdx_NdotR = dot(_484, _1894);
            float _rdx_horizon = clamp(1.0 + _rdx_NdotR, 0.0, 1.0);
            _rdx_horizon *= _rdx_horizon;
            _1972 *= _rdx_horizon;
        }
        // --- RenoDX: Diffuse BRDF (Sun directional light) ---
        float _rdx_sun_NdotH = clamp(dot(_484, normalize(_530 + _26._m0)), 0.0, 1.0);
        vec3 _rdx_sun_diffuse;
        if (pc.rendering_diffuse_brdf > 1.5) {
            _rdx_sun_diffuse = rdx_eon_diffuse(_2657, _625, 2.0 * _2655 * _2655 - 1.0, _559, _487);
        } else if (pc.rendering_diffuse_brdf > 0.5) {
            _rdx_sun_diffuse = rdx_hammon_diffuse(_2657, _625, _rdx_sun_NdotH, _2655, _559, _487);
        } else {
            _rdx_sun_diffuse = _487 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2664 * pow(spvNMax(abs(1.0 - _2657), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2664 * pow(spvNMax(abs(1.0 - _625), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _559)));
        }
        vec3 _2784 = ((_1424 + ((_2648 * _rdx_sun_diffuse) * _2657)) * mix(1.0, _2776, _34._m0.y)) + ((_1975 * _2392) * _2776);
