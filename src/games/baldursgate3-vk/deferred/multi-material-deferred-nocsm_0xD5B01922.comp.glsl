...
// --- RenoDX: EON 2025 Diffuse BRDF (Portsmouth, Kutz & Hill) ---
...
void main()
{
    do
    {
                ...
                if ((_10._m0[_3052]._m6 & (1u << (_485 & 31u))) != 0u)
                {
                    ...
                    if (_3086 < (1.0 / _3090))
                    {
                        ...
                        if (_3105 > 0.0)
                        {
                            ...
                            // --- RenoDX: Diffuse BRDF (Point Light, metallic) ---
                            vec3 _rdx_diffuse1;
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                float _rdx_VdotL1 = 2.0 * _3101 * _3101 - 1.0;
                                _rdx_diffuse1 = rdx_eon_diffuse(_3105, _3034, _rdx_VdotL1, _552, _520);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse1 = rdx_hammon_diffuse(_3105, _3034, _3103, _3101, _552, _520);
                            } else {
                                _rdx_diffuse1 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_3274 * pow(spvNMax(abs(1.0 - _3105), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_3274 * pow(spvNMax(abs(1.0 - _3034), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                            }
                            _3327 = fma(_3267, _rdx_diffuse1, _3043);
                        }
                        else
                        {
                            _3326 = _3041;
                ...
                if ((_10._m0[_3349]._m6 & (1u << (_485 & 31u))) != 0u)
                {
                    ...
                    if (_3381 < (1.0 / _3385))
                    {
                        ...
                        if (_3400 > 0.0)
                        {
                            ...
                            // --- RenoDX: Diffuse BRDF (Spot Light, metallic) ---
                            vec3 _rdx_diffuse2;
                            if (pc.rendering_diffuse_brdf > 1.5) {
                                float _rdx_VdotL2 = 2.0 * _3396 * _3396 - 1.0;
                                _rdx_diffuse2 = rdx_eon_diffuse(_3400, _3034, _rdx_VdotL2, _552, _520);
                            } else if (pc.rendering_diffuse_brdf > 0.5) {
                                _rdx_diffuse2 = rdx_hammon_diffuse(_3400, _3034, _3398, _3396, _552, _520);
                            } else {
                                _rdx_diffuse2 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_3559 * pow(spvNMax(abs(1.0 - _3400), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_3559 * pow(spvNMax(abs(1.0 - _3034), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                            }
                            _3612 = fma(_3552, _rdx_diffuse2, _3340);
                        }
                        else
                        {
                            _3611 = _3338;
                ...
                if (((_11._m0[_3634]._m4 & 16777215u) & (1u << (_485 & 31u))) != 0u)
                {
                    ...
                    if (all(lessThan(abs(_3674 - vec3(0.5)), vec3(0.5))))
                    {
                        ...
                        else
                        {
                            _3884 = _3618;
                            _3885 = _3621;
                            _3886 = ((_485 == 5u || _485 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _3779;
                        }
                        vec3 _3919;
                        if (_3663 >= 0)
                        {
                        ...
                        if ((_11._m0[_3634]._m1 & 1u) != 0u)
                        {
                            ...
                            if (_3691 > 0.0)
                            {
                                ...
                                // --- RenoDX: Diffuse BRDF (Area Light, metallic, shadow) ---
                                vec3 _rdx_diffuse3;
                                if (pc.rendering_diffuse_brdf > 1.5) {
                                    float _rdx_VdotL3 = 2.0 * _3687 * _3687 - 1.0;
                                    _rdx_diffuse3 = rdx_eon_diffuse(_3691, _3034, _rdx_VdotL3, _552, _520);
                                } else if (pc.rendering_diffuse_brdf > 0.5) {
                                    _rdx_diffuse3 = rdx_hammon_diffuse(_3691, _3034, _3689, _3687, _552, _520);
                                } else {
                                    _rdx_diffuse3 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_3998 * pow(spvNMax(abs(1.0 - _3691), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_3998 * pow(spvNMax(abs(1.0 - _3034), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                }
                                _4051 = fma(_3991, _rdx_diffuse3, _3625);
                            }
                            else
                            {
                                _4050 = _3623;
                        ...
                        else
                        {
                            ...
                            if (_3691 > 0.0)
                            {
                                ...
                                // --- RenoDX: Diffuse BRDF (Area Light, metallic, no shadow) ---
                                vec3 _rdx_diffuse4;
                                if (pc.rendering_diffuse_brdf > 1.5) {
                                    float _rdx_VdotL4 = 2.0 * _3687 * _3687 - 1.0;
                                    _rdx_diffuse4 = rdx_eon_diffuse(_3691, _3034, _rdx_VdotL4, _552, _520);
                                } else if (pc.rendering_diffuse_brdf > 0.5) {
                                    _rdx_diffuse4 = rdx_hammon_diffuse(_3691, _3034, _3689, _3687, _552, _520);
                                } else {
                                    _rdx_diffuse4 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_3933 * pow(spvNMax(abs(1.0 - _3691), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_3933 * pow(spvNMax(abs(1.0 - _3034), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                }
                                _3986 = fma(_3926, _rdx_diffuse4, _3625);
                            }
                            else
                            {
                                _3985 = _3623;
                        ...
                        if (_1985 < (1.0 / _1989))
                        {
                            ...
                            if (_10._m0[_1951]._m3 < 0.0)
                            {
                                ...
                                if (_2004 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Point Light, standard, shadow) ---
                                    vec3 _rdx_diffuse5;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        float _rdx_VdotL5 = 2.0 * _2000 * _2000 - 1.0;
                                        _rdx_diffuse5 = rdx_eon_diffuse(_2004, _1933, _rdx_VdotL5, _552, _520);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse5 = rdx_hammon_diffuse(_2004, _1933, _2002, _2000, _552, _520);
                                    } else {
                                        _rdx_diffuse5 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2226 * pow(spvNMax(abs(1.0 - _2004), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2226 * pow(spvNMax(abs(1.0 - _1933), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                    }
                                    _2266 = fma(_2219, _rdx_diffuse5, _1938);
                                }
                                else
                                {
                                    _2265 = _1935;
                            ...
                            else
                            {
                                ...
                                if (_2004 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Point Light, standard, no shadow) ---
                                    vec3 _rdx_diffuse6;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        float _rdx_VdotL6 = 2.0 * _2000 * _2000 - 1.0;
                                        _rdx_diffuse6 = rdx_eon_diffuse(_2004, _1933, _rdx_VdotL6, _552, _520);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse6 = rdx_hammon_diffuse(_2004, _1933, _2002, _2000, _552, _520);
                                    } else {
                                        _rdx_diffuse6 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2174 * pow(spvNMax(abs(1.0 - _2004), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2174 * pow(spvNMax(abs(1.0 - _1933), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                    }
                                    _2214 = fma(_2167, _rdx_diffuse6, _1938);
                                }
                                else
                                {
                                    _2213 = _1935;
                        ...
                        if (_2322 < (1.0 / _2326))
                        {
                            ...
                            if (_10._m0[_2290]._m3 < 0.0)
                            {
                                ...
                                if (_2341 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Spot Light, standard, shadow) ---
                                    vec3 _rdx_diffuse7;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        float _rdx_VdotL7 = 2.0 * _2337 * _2337 - 1.0;
                                        _rdx_diffuse7 = rdx_eon_diffuse(_2341, _1933, _rdx_VdotL7, _552, _520);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse7 = rdx_hammon_diffuse(_2341, _1933, _2339, _2337, _552, _520);
                                    } else {
                                        _rdx_diffuse7 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2553 * pow(spvNMax(abs(1.0 - _2341), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2553 * pow(spvNMax(abs(1.0 - _1933), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                    }
                                    _2593 = fma(_2546, _rdx_diffuse7, _2277);
                                }
                                else
                                {
                                    _2592 = _2274;
                            ...
                            else
                            {
                                ...
                                if (_2341 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Spot Light, standard, no shadow) ---
                                    vec3 _rdx_diffuse8;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        float _rdx_VdotL8 = 2.0 * _2337 * _2337 - 1.0;
                                        _rdx_diffuse8 = rdx_eon_diffuse(_2341, _1933, _rdx_VdotL8, _552, _520);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse8 = rdx_hammon_diffuse(_2341, _1933, _2339, _2337, _552, _520);
                                    } else {
                                        _rdx_diffuse8 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2501 * pow(spvNMax(abs(1.0 - _2341), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2501 * pow(spvNMax(abs(1.0 - _1933), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                    }
                                    _2541 = fma(_2494, _rdx_diffuse8, _2277);
                                }
                                else
                                {
                                    _2540 = _2274;
                    ...
                    if (((_11._m0[_2617]._m4 & 16777215u) & (1u << (_485 & 31u))) != 0u)
                    {
                        ...
                        if (all(lessThan(abs(_2657 - vec3(0.5)), vec3(0.5))))
                        {
                            ...
                            else
                            {
                                _2867 = _2606;
                                _2868 = _2608;
                                _2869 = ((_485 == 5u || _485 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _2762;
                            }
                            vec3 _2902;
                            if (_2646 >= 0)
                            {
                            ...
                            if ((_11._m0[_2617]._m1 & 1u) != 0u)
                            {
                                ...
                                if (_2674 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Area Light, standard, shadow) ---
                                    vec3 _rdx_diffuse9;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        float _rdx_VdotL9 = 2.0 * _2670 * _2670 - 1.0;
                                        _rdx_diffuse9 = rdx_eon_diffuse(_2674, _1933, _rdx_VdotL9, _552, _520);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse9 = rdx_hammon_diffuse(_2674, _1933, _2672, _2670, _552, _520);
                                    } else {
                                        _rdx_diffuse9 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2968 * pow(spvNMax(abs(1.0 - _2674), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2968 * pow(spvNMax(abs(1.0 - _1933), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                    }
                                    _3008 = fma(_2961, _rdx_diffuse9, _2604);
                                }
                                else
                                {
                                    _3007 = _2601;
                            ...
                            else
                            {
                                ...
                                if (_2674 > 0.0)
                                {
                                    ...
                                    // --- RenoDX: Diffuse BRDF (Area Light, standard, no shadow) ---
                                    vec3 _rdx_diffuse10;
                                    if (pc.rendering_diffuse_brdf > 1.5) {
                                        float _rdx_VdotL10 = 2.0 * _2670 * _2670 - 1.0;
                                        _rdx_diffuse10 = rdx_eon_diffuse(_2674, _1933, _rdx_VdotL10, _552, _520);
                                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                                        _rdx_diffuse10 = rdx_hammon_diffuse(_2674, _1933, _2672, _2670, _552, _520);
                                    } else {
                                        _rdx_diffuse10 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_2916 * pow(spvNMax(abs(1.0 - _2674), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_2916 * pow(spvNMax(abs(1.0 - _1933), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                    }
                                    _2956 = fma(_2909, _rdx_diffuse10, _2604);
                                }
                                else
                                {
                                    _2955 = _2601;
                            ...
                            if (_680 < (1.0 / _684))
                            {
                                ...
                                if (_10._m0[_646]._m3 < 0.0)
                                {
                                    ...
                                    if (_699 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Point Light, inner, shadow) ---
                                        vec3 _rdx_diffuse11;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            float _rdx_VdotL11 = 2.0 * _695 * _695 - 1.0;
                                            _rdx_diffuse11 = rdx_eon_diffuse(_699, _628, _rdx_VdotL11, _552, _520);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse11 = rdx_hammon_diffuse(_699, _628, _697, _695, _552, _520);
                                        } else {
                                            _rdx_diffuse11 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_955 * pow(spvNMax(abs(1.0 - _699), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_955 * pow(spvNMax(abs(1.0 - _628), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                        }
                                        _1029 = fma(_948, _rdx_diffuse11, _633);
                                    }
                                    else
                                    {
                                        _1028 = _630;
                                ...
                                else
                                {
                                    ...
                                    if (_699 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Point Light, inner, no shadow) ---
                                        vec3 _rdx_diffuse12;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            float _rdx_VdotL12 = 2.0 * _695 * _695 - 1.0;
                                            _rdx_diffuse12 = rdx_eon_diffuse(_699, _628, _rdx_VdotL12, _552, _520);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse12 = rdx_hammon_diffuse(_699, _628, _697, _695, _552, _520);
                                        } else {
                                            _rdx_diffuse12 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_869 * pow(spvNMax(abs(1.0 - _699), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_869 * pow(spvNMax(abs(1.0 - _628), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                        }
                                        _943 = fma(_862, _rdx_diffuse12, _633);
                                    }
                                    else
                                    {
                                        _942 = _630;
                            ...
                            if (_1085 < (1.0 / _1089))
                            {
                                ...
                                if (_10._m0[_1053]._m3 < 0.0)
                                {
                                    ...
                                    if (_1104 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Spot Light, inner, shadow) ---
                                        vec3 _rdx_diffuse13;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            float _rdx_VdotL13 = 2.0 * _1100 * _1100 - 1.0;
                                            _rdx_diffuse13 = rdx_eon_diffuse(_1104, _628, _rdx_VdotL13, _552, _520);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse13 = rdx_hammon_diffuse(_1104, _628, _1102, _1100, _552, _520);
                                        } else {
                                            _rdx_diffuse13 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1350 * pow(spvNMax(abs(1.0 - _1104), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1350 * pow(spvNMax(abs(1.0 - _628), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                        }
                                        _1424 = fma(_1343, _rdx_diffuse13, _1040);
                                    }
                                    else
                                    {
                                        _1423 = _1037;
                                ...
                                else
                                {
                                    ...
                                    if (_1104 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Spot Light, inner, no shadow) ---
                                        vec3 _rdx_diffuse14;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            float _rdx_VdotL14 = 2.0 * _1100 * _1100 - 1.0;
                                            _rdx_diffuse14 = rdx_eon_diffuse(_1104, _628, _rdx_VdotL14, _552, _520);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse14 = rdx_hammon_diffuse(_1104, _628, _1102, _1100, _552, _520);
                                        } else {
                                            _rdx_diffuse14 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1264 * pow(spvNMax(abs(1.0 - _1104), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1264 * pow(spvNMax(abs(1.0 - _628), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                        }
                                        _1338 = fma(_1257, _rdx_diffuse14, _1040);
                                    }
                                    else
                                    {
                                        _1337 = _1037;
                        ...
                        if (((_11._m0[_1448]._m4 & 16777215u) & (1u << (_485 & 31u))) != 0u)
                        {
                            ...
                            if (all(lessThan(abs(_1488 - vec3(0.5)), vec3(0.5))))
                            {
                                ...
                                else
                                {
                                    _1698 = _1437;
                                    _1699 = _1439;
                                    _1700 = ((_485 == 5u || _485 == 7u) && pc.hero_lighting > 0.5) ? 0.0 : _1593;
                                }
                                vec3 _1733;
                                if (_1477 >= 0)
                                {
                                ...
                                if ((_11._m0[_1448]._m1 & 1u) != 0u)
                                {
                                    ...
                                    if (_1505 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Area Light, inner, shadow) ---
                                        vec3 _rdx_diffuse15;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            float _rdx_VdotL15 = 2.0 * _1501 * _1501 - 1.0;
                                            _rdx_diffuse15 = rdx_eon_diffuse(_1505, _628, _rdx_VdotL15, _552, _520);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse15 = rdx_hammon_diffuse(_1505, _628, _1503, _1501, _552, _520);
                                        } else {
                                            _rdx_diffuse15 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1833 * pow(spvNMax(abs(1.0 - _1505), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1833 * pow(spvNMax(abs(1.0 - _628), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                        }
                                        _1907 = fma(_1826, _rdx_diffuse15, _1435);
                                    }
                                    else
                                    {
                                        _1906 = _1432;
                                ...
                                else
                                {
                                    ...
                                    if (_1505 > 0.0)
                                    {
                                        ...
                                        // --- RenoDX: Diffuse BRDF (Area Light, inner, no shadow) ---
                                        vec3 _rdx_diffuse16;
                                        if (pc.rendering_diffuse_brdf > 1.5) {
                                            float _rdx_VdotL16 = 2.0 * _1501 * _1501 - 1.0;
                                            _rdx_diffuse16 = rdx_eon_diffuse(_1505, _628, _rdx_VdotL16, _552, _520);
                                        } else if (pc.rendering_diffuse_brdf > 0.5) {
                                            _rdx_diffuse16 = rdx_hammon_diffuse(_1505, _628, _1503, _1501, _552, _520);
                                        } else {
                                            _rdx_diffuse16 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_1747 * pow(spvNMax(abs(1.0 - _1505), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_1747 * pow(spvNMax(abs(1.0 - _628), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                                        }
                                        _1821 = fma(_1740, _rdx_diffuse16, _1435);
                                    }
                                    else
                                    {
                                        _1820 = _1432;
        ...
        if (_34._m0.x > 0.0) {
            _rdx_early_ao = textureLod(sampler2D(_40, _12), _414, 0.0).x;
        }
        // --- RenoDX: IBL Modulation ---
        if (pc.rendering_cubemap_mod > 0.5) {
            float rdx_mod = rdx_cubemap_modulation(_4112, _552, _rdx_early_ao);
            _4111 *= rdx_mod;
            _4112 *= rdx_mod;
        }
        ...
        for (uint _4152 = _4143; _4152 < _4145; _4147 = _4148, _4150 = _4151, _4152++)
        {
            ...
            if ((_4178 & 1) != 0)
            {
                ...
                if (pc.rendering_cubemap_mod > 0.5) {
                    _4382.xyz *= mix(0.4, 1.0, _rdx_early_ao);
                }
                float _rdx_probeBlendD = _4382.w;
                if ((_485 == 5u || _485 == 7u) && pc.hero_lighting > 0.5) {
                    _rdx_probeBlendD *= 0.3;
                }
                _4387 = mix(_4150, _4382.xyz, vec3(_rdx_probeBlendD));
            }
            else
            {
                _4387 = _4150;
            ...
            if ((_4178 & 2) != 0)
            {
                ...
                if (pc.rendering_cubemap_mod > 0.5) {
                    _4561.xyz *= mix(0.4, 1.0, _rdx_early_ao);
                }
                float _rdx_probeBlendS = _4561.w;
                if ((_485 == 5u || _485 == 7u) && pc.hero_lighting > 0.5) {
                    _rdx_probeBlendS *= 0.3;
                }
                _4566 = mix(_4147, _4561.xyz, vec3(_rdx_probeBlendS));
            }
            else
            {
                _4566 = _4147;
        ...
        if (_601)
        {
            ...
            // --- RenoDX: Diffuse BRDF (Sun, metallic) ---
            float _rdx_sun_NdotH17 = clamp(dot(_495, normalize(_523 + _26._m0)), 0.0, 1.0);
            vec3 _rdx_sun_diffuse17;
            if (pc.rendering_diffuse_brdf > 1.5) {
                float _rdx_sun_VdotL17 = 2.0 * _5031 * _5031 - 1.0;
                _rdx_sun_diffuse17 = rdx_eon_diffuse(_5033, _5027, _rdx_sun_VdotL17, _552, _520);
            } else if (pc.rendering_diffuse_brdf > 0.5) {
                _rdx_sun_diffuse17 = rdx_hammon_diffuse(_5033, _5027, _rdx_sun_NdotH17, _5031, _552, _520);
            } else {
                _rdx_sun_diffuse17 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_5040 * pow(spvNMax(abs(1.0 - _5033), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_5040 * pow(spvNMax(abs(1.0 - _5027), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
            }
            _5116 = _4059 + ((_4823 * _rdx_sun_diffuse17) * _5033);
        }
        else
        {
            vec3 _5021;
            ...
            if (_505)
            {
                ...
                // --- RenoDX: Diffuse BRDF (Sun, standard) ---
                float _rdx_sun_NdotH18 = clamp(dot(_495, normalize(_523 + _26._m0)), 0.0, 1.0);
                vec3 _rdx_sun_diffuse18;
                if (pc.rendering_diffuse_brdf > 1.5) {
                    float _rdx_sun_VdotL18 = 2.0 * _4953 * _4953 - 1.0;
                    _rdx_sun_diffuse18 = rdx_eon_diffuse(_4955, _4949, _rdx_sun_VdotL18, _552, _520);
                } else if (pc.rendering_diffuse_brdf > 0.5) {
                    _rdx_sun_diffuse18 = rdx_hammon_diffuse(_4955, _4949, _rdx_sun_NdotH18, _4953, _552, _520);
                } else {
                    _rdx_sun_diffuse18 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_4962 * pow(spvNMax(abs(1.0 - _4955), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_4962 * pow(spvNMax(abs(1.0 - _4949), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                }
                _5022 = _4059 + ((_4823 * _rdx_sun_diffuse18) * _4955);
            }
            else
            {
                vec3 _4943;
                ...
                if (_4063)
                {
                    ...
                    // --- RenoDX: Diffuse BRDF (Sun, inner) ---
                    float _rdx_sun_NdotH19 = clamp(dot(_495, normalize(_523 + _26._m0)), 0.0, 1.0);
                    vec3 _rdx_sun_diffuse19;
                    if (pc.rendering_diffuse_brdf > 1.5) {
                        float _rdx_sun_VdotL19 = 2.0 * _4840 * _4840 - 1.0;
                        _rdx_sun_diffuse19 = rdx_eon_diffuse(_4842, _4836, _rdx_sun_VdotL19, _552, _520);
                    } else if (pc.rendering_diffuse_brdf > 0.5) {
                        _rdx_sun_diffuse19 = rdx_hammon_diffuse(_4842, _4836, _rdx_sun_NdotH19, _4840, _552, _520);
                    } else {
                        _rdx_sun_diffuse19 = _520 * (0.3183098733425140380859375 * (((vec3(1.0) + (_4849 * pow(spvNMax(abs(1.0 - _4842), 9.9999997473787516355514526367188e-05), 5.0))).x * (vec3(1.0) + (_4849 * pow(spvNMax(abs(1.0 - _4836), 9.9999997473787516355514526367188e-05), 5.0))).x) * mix(1.0, 0.662251651287078857421875, _552)));
                    }
                    _4944 = _4059 + ((_4823 * _rdx_sun_diffuse19) * _4842);
                }
                else
                {
                    _4943 = _4058;
        ...
        if (pc.rendering_specular_occlusion > 0.5) {
            float _rdx_specOcc = clamp(
                pow(spvNMax(abs(_4113 + _5137), 1e-7),
                    exp2(-16.0 * _552 - 1.0)) - 1.0 + _5137,
                0.0, 1.0);
            float _rdx_specOccBlend = mix(_rdx_specOcc, 1.0, (1.0 - _552) * 0.5);
            _4147 *= _rdx_specOccBlend;
        }
        // --- RenoDX: AO-Weighted Probe Light Leak Fix ---
        if (pc.rendering_probe_ao > 0.5) {
            float _rdx_probe_weight = mix(1.0, _5137, 0.6);
            _4147 *= _rdx_probe_weight;
            _4150 *= _rdx_probe_weight;
        }
        // --- RenoDX: Horizon Occlusion on Indirect Light ---
        if (pc.rendering_horizon_occlusion > 0.5) {
            float _rdx_NdotR = dot(_495, _4061);
