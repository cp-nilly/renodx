...
#define RENODX_RENDERING_FOG_HAZE_AA             shader_injection.rendering_fog_haze_aa
#define RENODX_RENDERING_FOG_COLOR_CORRECTION    shader_injection.rendering_fog_color_correction
